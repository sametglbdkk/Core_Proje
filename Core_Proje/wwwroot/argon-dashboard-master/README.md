...
Bu projede, [Argon Dashboard](https://www.creative-tim.com/product/argon-dashboard) kullanılmıştır. Bu araç, Bootstrap 4 tabanlı bir yönetim panosu olup, projelerinize hızlı ve etkili bir başlangıç yapmanızı sağlar.
